...
export default function Header() {
    ...
    return (
        ...
        <span
            className={cn(
                "block w-full h-0.5 bg-texto-claro rounded-full transition-transform duration-300 ease-in-out",
                { "transform rotate-45 translate-y-[11px]": menuOpen }
            )}
        ></span>
                <span
                    className={cn(
                        "block w-full h-0.5 bg-texto-claro rounded-full transition-opacity duration-300 ease-in-out",
                        { "opacity-0": menuOpen }
                    )}
                ></span>
                <span

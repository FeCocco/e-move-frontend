...
const TelaInicial = () => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full text-white bg-gradient-body">
            ...
            <div className="relative z-20 h-full w-full overflow-y-auto">
                ...
                <div className="min-h-screen flex justify-center items-center p-4">
                    ...
                    <div className="flex flex-col items-center text-center max-w-[80%] font-josefin-sans animate-welcome-fade-in opacity-0">

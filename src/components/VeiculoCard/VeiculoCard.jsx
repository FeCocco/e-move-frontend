    ...
    return (
        <AppCard className="p-4 bg-black/40 min-h-64">
            ...
            <div className="p-2 flex flex-col gap-2">
                <p className="text-gray-400/50">Status: <span>{status}</span> (ainda não implementado)</p>
                <p className="text-gray-400/50">Bateria: <span>{bateria}%</span> (ainda não implementado)</p>
                <p>Autonomia total: <span>{autonomiaTotal} km</span></p>
                <p className="text-gray-400/50">Autonomia Estimada: <span>{autonomiaEstimada} km</span> (ainda não implementado)</p>
                <p className="text-gray-400/50">KM Rodados: <span>{KmRodados} km</span> (ainda não implementado)</p>
            </div>

        ...
        <section id="sobre-nos" className="w-full py-32 px-6 text-center">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    <TiltCard icon={BugPlay} animation="animate-pulseGlow">
                    ...
                    <TiltCard icon={Database} animation="animate-floatVertical">
                    ...
                    <TiltCard icon={Network} animation="animate-flicker">
                    ...
                    <TiltCard icon={Code} animation="animate-rocking">
                    ...
                    <TiltCard icon={Laptop} animation="animate-pulseExpand">
